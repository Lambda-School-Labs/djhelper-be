...
// TODO: Remove const playlistsConnects = require('./playlistsConnectionRouter.js');
...
// router.use('/playlist', playlistRouter); // Move to event
// TODO: Remove router.use('/playlistconnects', playlistsConnects);
